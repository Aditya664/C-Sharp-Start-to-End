...
//With basic data types such as int, string , float, double which are best in performing bacis operation.
//Real world is a little more complex than just basic operations.
//Classes are best for representing complex things like in real life situations

//i.e There is no way to represent an animal with int or float or double.
//  Here is where Classes comes to the rescue
//A class is like a blue-print i.e it defines all the attribute and properties it should have


//We can have a class Animal
//We can give it some attribues like, Move, Legs etc.

//Or we can have a class House and give it some properties like Size, Color, Shape, etc.
