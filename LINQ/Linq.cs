...
// Running a loop over a million record will take a lot of time and resources
// that can be better utilized LINQ makes it easy to easily get the record you
// want There are two syntax of writing LINQ Query Syntax - which looks more or
// less like a SQL query language Method Syntax - which looks like C# syntax

class Linq {
  public static void Main(String[] args) {
    // we have some list of students
    // To get an student that meets a certain criteria using a loop we will have
    // loop over all the list of student
    ...
    var querySyntax = from s in studentList
                      where s.Age> 12 And s.Age<20 _ Select s).ToList();
    ...
    var methodSyntax =
        studentList.where(x => x.Age > 12 && x.Age < 20).ToList();
    // Sweet and concise

    // The Query syntax and the method syntax returns the same value. it is a
    // matter of prefrences
